  ...
  <div class="container">
    <div class="row onh" style="max-width: 85%;margin:auto;">
      ...
      <div class="col-md-6 mt-4" style="position: relative;">
        ...
        <div class="" style="position: absolute;bottom:5px;">
          <h5 class=" text-white">OpenAi Sora Introduction→</h5>
        </div>
      </div>
      <div class="col-md-6 mt-4" style="position: relative;">
        <img src="assets/img/ty3.png" alt="" width="100%">
        <div class="" style="position: absolute;bottom:5px;">
          <h5 class="text-white">Nvidia becomes bigger than <br>apple, taking no. 1 spot→</h5>
        </div>
      </div>
      <div class="col-md-6 mt-4" style="position: relative;">
        <img src="assets/img/ty4.png" alt="" width="100%">
        <div class="" style="position: absolute;bottom:5px;">
          <h5 class=" text-white">Apple launches their Ai→</h5>
        </div>
      </div>
