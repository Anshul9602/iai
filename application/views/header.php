...
<body>
  ...
  <header id="header" class="header d-flex align-items-center addclass nav-down" style="   width:100%;">
    ...
    <div class="container-fluid container-xl d-flex align-items-center  row " style="max-width: 100%;margin: auto;        justify-content: space-around;">
    <a href="<?php echo base_url(); ?>" class="mob logo  align-items-center col-md-2 col-6 justify-content-start">
...
<img class="ds" src="assets/img/log.png" style="max-width:250px;" alt="">
      ...
      <nav id="navbar" class="navbar  ">
        ...
        <a href="<?php echo base_url(); ?>" class="desk logo d-flex align-items-center col-md-6 col-6 justify-content-center">
